                    ...
                    <div class="sm:rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="mt-4 text-sm text-gray-500">
                                <form action="actiondeposit.php" method="POST">
                                    <!-- Input Field -->
                                    <div class="relative mt-2 rounded-md">
                                        ...
                                        <input type="number" name="deposit" id="amount" class="block w-full ring-0 outline-none text-xl pl-4 py-2 sm:pl-8 text-gray-800 border-b border-b-emerald-500 placeholder:text-gray-400 sm:text-4xl" placeholder="0.00" required />
                                    </div>
