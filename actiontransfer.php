...
if (isset($_POST['add_record'])) {
        ...
        if ($transfer <= $senders_balance && $transfer > 0) {
            ...
            try {
                ...
                $sql1 = 'INSERT INTO transactions (receiver_name, receiver_email, amount,type, date)
                     VALUES (:receiver_name, :receiver_email, :transfer,:type, NOW())';
    ...
    //ensure transfer money is not negative
    //add tranfer money to the balance of receiver
    //deduct transfer money from balance of receiver
    //enter into transactions with type equals to transfer

    //If email exsists find balance of the receiber 
    ...
    //         // INSERT INTO transactions query
    //         $sql1 = 'INSERT INTO transactions (receiver_name, receiver_email, amount,type, date)
    //                  VALUES (:receiver_name, :receiver_email, :deposit,:type, NOW())';
