                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            ...
                            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                                <a href="adminaddcustomers.php" type="button" class="block px-3 py-2 text-sm font-semibold text-center text-white rounded-md shadow-sm bg-sky-600 hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600">
                                    Add Customer
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="flow-root mt-8">
                            <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                <ul role="list" class="divide-y divide-gray-100">
                                    <?php if (count($allusers)) foreach ($allusers as $arr) : ?>
                                            ...
                                            <div class="flex gap-x-4">
                                                ...
                                                <div class="flex-auto min-w-0">
                                                    ...
                                                    <p class="flex mt-1 text-xs leading-5 text-gray-500">
                                                        <a href="./customer_transactions.html" class="relative truncate hover:underline"><?php echo $arr->email; ?></a>
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
